Pod::Spec.new do |s|
  ...
  s.resource_bundles = {'GTCUIResources' => ['GTCUI/Resources/*.{xcassets}', 'GTCUI/Resources/RamadanScene.sks', 'GTCUI/External Resources/Fonts/*.{ttf}', 'GTCUI/Resources/MarkdownAssets/*']}
