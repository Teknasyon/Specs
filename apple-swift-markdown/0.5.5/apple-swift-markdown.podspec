Pod::Spec.new do |s|
    ...
    s.homepage = "https://github.com/Teknasyon/swift-markdown-pod"
    s.license = { :type => "Apache", :file => "LICENSE.txt" }
    s.author = { 
        "Apple" => "apple@apple.com",
        "Pleisto" => "engineering@pleisto.com",
	"Seyfeddin Bassarac" => "seyfeddinbassarac@teknasyon.com"
    }
    s.source = { 
        :git => "https://github.com/Teknasyon/swift-markdown-pod.git", 
	:tag => "#{s.version}" 
    }
